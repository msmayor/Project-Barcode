...
class ServicereportController extends Controller
{
    ...
    public function actionCreate()
    {
         ...
         if ( Yii::$app->user->can( 'Create Service Report' ) )
        {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->file->saveAs( 'uploads/servicereports'.$documentName.'.'.$model->file->extension );
            $model->Document = 'uploads/servicereports'.$documentName.'.'.$model->file->extension;
        ...
        throw new ForbiddenHttpException(' You lack the privilege to access this function ');
    }
    ...
    {
         if ( Yii::$app->user->can( 'Delete Service Report' ) )
        {
